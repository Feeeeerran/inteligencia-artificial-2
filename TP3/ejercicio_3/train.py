...
def train(x, t, pesos, learning_rate, epochs):
    ...
    for i in range(epochs):
        ...
        if i %100 == 0:
            ...
            loss_validacion = validacion(xv,tv,pesos)
            # print(loss_validacion)
            if i>100:
                if loss_anterior - loss_validacion < 0:
                    print("Loss empieza a aumentar, epoch ",i)
                    break
            
            loss_anterior = loss_validacion
